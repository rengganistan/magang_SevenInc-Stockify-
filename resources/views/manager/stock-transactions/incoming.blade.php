...
<div class="w-full px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
        <div>
            <p class="text-sm text-gray-400 mb-2">Dashboard / Barang Masuk</p>
            <h1 class="text-3xl lg:text-4xl font-bold text-white">Barang Masuk</h1>
            <p class="mt-2 text-gray-400">Daftar seluruh transaksi barang masuk.</p>
        </div>
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('manager.transactions.create', ['type' => 'Masuk']) }}"
